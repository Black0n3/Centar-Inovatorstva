...
<div class='row'>
    ...
    <div class="title">
      ...
      <div class="well">
            ...
            <div>
                <img id='img-crop' src='{{ asset('') }}{{ '/'.$projekt->slika }}' class='img-responsive sjena'>
            </div>
            {!! Form::open(['url'=>'dashboard/projekti/'.$projekt->id.'/slikaspremi', 'files' => true]) !!}
                ...
                <div class="form-group">
                    {!! Form::submit('Spremi projekt',['class' => 'btn btn-primary form-control']) !!}
                </div>
